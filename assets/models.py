...
class Asset(models.Model):
    ...
    environment = models.CharField(max_length=128, blank=True,null=True, verbose_name='环境详情')
    name = models.CharField(max_length=64, unique=False, verbose_name='资产名称')  # 不可重复
...
class Server(models.Model):
    ...
    sub_asset_type = models.SmallIntegerField(choices=sub_asset_type_choice, default=0, verbose_name="服务资源类型")
    ...
    model = models.CharField(max_length=128, null=True, blank=True, verbose_name='服务资源型号')
